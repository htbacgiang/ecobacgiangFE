...
const getApiBaseUrl = () => {
  ...
  if (typeof window !== 'undefined') {
    ...
    // Trong development mode, fallback về localhost nếu chưa set
...
class ApiClient {
  ...
  async request(endpoint, options = {}, retryCount = 0) {
    ...
    try {
      ...
      if (!response.ok) {
        // Nếu là 404 hoặc 400 với message, trả về data để frontend xử lý thông báo
        // Thay vì throw Error để frontend có thể hiển thị thông báo một cách nhẹ nhàng
