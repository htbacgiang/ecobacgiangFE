 ...
 * Sử dụng apiClient để gọi đến server Node.js
 */
...
export const authService = {
  ...
  signin: async (email, password) => {
    ...
    // Kiểm tra nếu có thông báo cảnh báo (như tài khoản chưa kích hoạt)
    // Thì throw Error với message để frontend có thể hiển thị thông báo
    if (response._isWarning && response.message) {
  ...
  resendEmailOTP: async (email) => {
    return apiClient.post('/auth/resend-email-otp', { email });
  },
