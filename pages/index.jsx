...
import SupplierBanner from "../components/ecobacgiang/SupplierBanner";
...
export default function Home({ posts, meta }) {
  // JSON-LD Schema.org: Organization (thương hiệu)
  ...
  // JSON-LD Schema.org: WebSite — dùng để Google hiển thị tên trang "Eco Bắc Giang" phía trên URL và hỗ trợ sitelinks
  const jsonLdWebSite = {
    "@context": "https://schema.org",
    "@type": "WebSite",
    name: "Eco Bắc Giang",
    alternateName: "Eco Bac Giang",
    url: "https://ecobacgiang.vn",
    description:
      "Eco Bắc Giang – nông nghiệp thông minh, sản xuất hữu cơ bền vững. Ứng dụng IoT, AI và công nghệ xanh hướng tới Net Zero 2050.",
    publisher: {
      "@type": "Organization",
      name: "Eco Bắc Giang",
      logo: { "@type": "ImageObject", url: "https://ecobacgiang.vn/logo.png" },
    },
    potentialAction: {
      "@type": "SearchAction",
      target: {
        "@type": "EntryPoint",
        urlTemplate: "https://ecobacgiang.vn/san-pham?q={search_term_string}",
      },
  ...
  return (
    <DefaultLayout meta={meta}>
      <Head>
        ...
        />
        {/* JSON-LD: WebSite — tên trang phía trên URL + hỗ trợ sitelinks */}
        <script
          type="application/ld+json"
      ...
      <div className="container mx-auto py-6">
        <div className="flex flex-col items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 uppercase">Bài viết mới nhất</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pb-6 px-4 md:px-0">
